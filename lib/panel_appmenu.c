...
static int widget_draw_appmenu(struct PanelWidget * this, gfx_context_t * ctx) {
	...
	int w = tt_string_width_cjk(this->pctx->font, this->pctx->font_cjk, "\xe5\xba\x94\xe7\x94\xa8\xe7\xa8\x8b\xe5\xba\x8f");
	tt_draw_string_cjk(ctx, this->pctx->font, this->pctx->font_cjk, (ctx->width - w) / 2, 20, "\xe5\xba\x94\xe7\x94\xa8\xe7\xa8\x8b\xe5\xba\x8f", appmenu->window ? this->pctx->color_text_hilighted : this->pctx->color_text_normal);
	return 0;
}
